  ...
  forecast.forEach(function (forecastDay) {
    forecastHTML =
      ...
      <div class="col-2">
        ...
        <img src="http://openweathermap.org/img/wn/${forecastDay.weather[0].icon}.png" alt="" width="36" />
        <div>
          <span class="weather-forecast-max">${forecast.temp.max}°</span>
          <span class="weather-forecast-min">${forecast.temp.min}°</span>
        </div>
      </div>
    `;
  });
